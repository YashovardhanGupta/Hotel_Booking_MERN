      ...
      <form onSubmit={onSubmitHandler} onClick={(e) => e.stopPropagation()} className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
                ...
                <input type="text" placeholder='Type Here' name="" id="name" onChange={(e) => setName(e.target.value)} value={name} className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
            </div>
            {/* Phone number */}
            <div className='w-full mt-4'>
                ...
                <input type="text" placeholder='Type Here' onChange={(e) => setContact(e.target.value)} value={contact} name="" id="contact" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
            </div>
            {/* Address */}
            <div className='w-full mt-4'>
                ...
                <input type="text" placeholder='Type Here' name="" id="address" onChange={(e) => setAddress(e.target.value)} value={address} className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
            </div>
