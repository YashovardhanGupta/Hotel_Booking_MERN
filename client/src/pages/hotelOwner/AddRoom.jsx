...
const AddRoom = () => {
  ...
  return (
    <form >
        ...
        <div className='grid grid-cols-2 sm:flex gap-4 my-2 felx-wrap'>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
            ...
            <div>
                ...
                <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24 no-arrows' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs, pricePerNight: e.target.value})}/>
            </div>
